        ...
        <div className="min-h-screen gradient-hero flex items-center justify-center p-4">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-[#8892a4]">Sign in to continue to your dashboard</p>
                </div>
                ...
                <div className="bg-[#1a2235] border border-[#1e2d40] rounded-2xl p-8">
                    ...
                    <p className="text-center text-sm text-[#8892a4] mt-6">
                        ...
                        <Link href="/signup" className="text-[#FF9900] hover:text-[#e68a00] font-medium">
                            Create one
                        </Link>
                    </p>
                </div>
                ...
                <p className="text-center text-xs text-[#8892a4] mt-6">
                    <Link href="/demo" className="text-[#00d4ff] hover:underline">
                        Try the demo →
                    </Link>{" "}
                    No account needed
                </p>
...
export default function LoginPage() {
    return (
        <Suspense fallback={<div className="min-h-screen gradient-hero flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-[#FF9900]" /></div>}>
            <LoginForm />
        </Suspense>
    );
}
